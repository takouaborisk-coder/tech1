...
class Huaiwe extends StatefulWidget {
  const Huaiwe({super.key});

  @override
  State<Huaiwe> createState() => _HuaiweState();
}

class _HuaiweState extends State<Huaiwe> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: fetchpost(mobile: 'huawei'),
